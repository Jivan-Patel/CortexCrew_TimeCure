...
export const Logo = ({ className = "w-10 h-10" }) => {
  return (
    <div className={`relative flex items-center justify-center bg-red-600 rounded-xl shadow-md overflow-hidden shrink-0 ${className}`}>
      ...
      <div className="absolute z-10 bg-white rounded-full p-[2px] shadow-sm">
        <Clock className="text-red-600 w-4 h-4 flex-shrink-0" strokeWidth={3} />
      </div>
    </div>
  );
};
